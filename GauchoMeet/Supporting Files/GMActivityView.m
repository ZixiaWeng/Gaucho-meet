...
static CGFloat const GMActivityViewLabelCenterXOffset = 5.0f;
static CGFloat const GMActivityViewActivityIndicatorRightInset = 10.0f;
...
- (void)layoutSubviews {
    ...
    labelFrame.origin.x = CGRectGetMidX(bounds) - CGRectGetMidX(labelFrame) + GMActivityViewLabelCenterXOffset;
    ...
    activityIndicatorFrame.origin.x = CGRectGetMinX(labelFrame) - CGRectGetWidth(activityIndicatorFrame) - GMActivityViewActivityIndicatorRightInset;
